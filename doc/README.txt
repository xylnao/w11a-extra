...
2. Files ---------------------------------------------------------------------
   ...
   rtl/bplib/avmb                 - for Avnet Microboard
   ...
   rtl/sys_gen/tst_rlink          - top level designs for an rlink tester
     avmb,nexys2,nexys3,s3board   - systems for Avmb,Nexsy2,Nexsy3,S3BOARD
...
- not in repository (2011-02-25)

  - Summary
    - added support for Avnet Microboard for w11a
    - generalized the 'human I/O' interface for avmb

  - New features
    - new systems
      - sys_gen/w11a/avmb/sys_w11a_mb
      - sys_gen/w11a/tst_rlink/avmb
