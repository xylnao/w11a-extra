...
# 2012-02-25   ???   1.0.?  add new avmb ports
...
SYN_all += rtl/sys_gen/tst_rlink/avmb
...
SIM_all += rtl/sys_gen/tst_rlink/avmb/tb
...
SIM_all += rtl/sys_gen/w11a/avmb/tb
